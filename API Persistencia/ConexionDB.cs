...
namespace API_Persistencia
{
    public class ConexionDB : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PublicacionCaracteristica>()
                .HasKey(sc => new { sc.PublicacionId, sc.CaracteristicaId });
        }
        ...
        public DbSet<PublicacionCaracteristica> PublicacionCaracteristica { get; set; }
