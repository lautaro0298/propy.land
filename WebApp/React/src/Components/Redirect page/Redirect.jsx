...
const Redirect = () => {
  const { redirect } = useSelector((state) => state.redirectData);
  const logoObj = {
    ...
    <StyledRedirect>
      <div className="cont">
        <div>
          ...
          <img src={logoObj[redirect]} alt="img" />
        </div>
        <h1>
          You found a great deal on trivago Taking you to the {redirect} website
        </h1>
      </div>
    </StyledRedirect>
  );
